...
{
    public static class HTMLCleaner2
    {
            ...
            new Dictionary<string, string[]>
        {
            {"html", null},    
            {"title", null},
            {"meta", new string[]          {"description", "keywords"}},

            {"body", new string[]          {"style", "class", "align"}},
        ...
        {
            source = System.Web.HttpUtility.HtmlDecode(source); // desescapar caracteres especiales
            ...
            foreach (KeyValuePair<string, string[]> tag in ValidHtmlTags)
            {
                ...
                foreach (var n in nodes)
                {
                    ...
                    {
                        if ((tag.Value != null) && !tag.Value.Contains(a.Name))
                        {
                        ...
                        {
                            // AntiXss
                            a.Value = HttpUtility.UrlPathEncode(a.Value);
                        }
                    }
                }
            }
